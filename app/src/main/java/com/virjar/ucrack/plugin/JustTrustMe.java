...
public class JustTrustMe {
    ...
    private static void trustAllCertificateInternal() throws Throwable {
        ...
        currentPackageName = SharedObject.loadPackageParam.packageName;
        ...
        findAndHookMethod("org.apache.http.conn.ssl.SSLSocketFactory", SharedObject.loadPackageParam.classLoader, "getSocketFactory", new XC_MethodReplacement() {
            @Override
        ...
        findAndHookMethod("org.apache.http.conn.ssl.SSLSocketFactory", SharedObject.loadPackageParam.classLoader, "isSecure", Socket.class, new XC_MethodReplacement() {
            @Override
            protected Object replaceHookedMethod(MethodHookParam param) throws Throwable {
                return true;
            }
        ...
        findAndHookMethod("javax.net.ssl.TrustManagerFactory", SharedObject.loadPackageParam.classLoader, "getTrustManagers", new XC_MethodHook() {
            @Override
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {

                if (hasTrustManagerImpl()) {
                    Class<?> cls = findClass("com.android.org.conscrypt.TrustManagerImpl", SharedObject.loadPackageParam.classLoader);
        ...
        findAndHookMethod("javax.net.ssl.HttpsURLConnection", SharedObject.loadPackageParam.classLoader, "setDefaultHostnameVerifier",
        ...
        findAndHookMethod("javax.net.ssl.HttpsURLConnection", SharedObject.loadPackageParam.classLoader, "setSSLSocketFactory", javax.net.ssl.SSLSocketFactory.class,
        ...
        findAndHookMethod("javax.net.ssl.HttpsURLConnection", SharedObject.loadPackageParam.classLoader, "setHostnameVerifier", HostnameVerifier.class,
                new XC_MethodReplacement() {
                    @Override
                    protected Object replaceHookedMethod(MethodHookParam param) throws Throwable {
                        return null;
        ...
        findAndHookMethod("android.webkit.WebViewClient", SharedObject.loadPackageParam.classLoader, "onReceivedSslError",
        ...
        findAndHookMethod("android.webkit.WebViewClient", SharedObject.loadPackageParam.classLoader, "onReceivedError",
        ...
        findAndHookMethod("javax.net.ssl.SSLContext", SharedObject.loadPackageParam.classLoader, "init", KeyManager[].class, TrustManager[].class, SecureRandom.class, new XC_MethodHook() {
        ...
        findAndHookMethod("android.app.Application",
                SharedObject.loadPackageParam.classLoader,
                "attach",
                Context.class,
                new XC_MethodHook() {
                    @Override
        ...
        if (hasTrustManagerImpl()) {
            ...
            findAndHookMethod("com.android.org.conscrypt.TrustManagerImpl", SharedObject.loadPackageParam.classLoader,
